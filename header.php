...
<body class="preloader-visible" data-barba="wrapper">
    <div class="preloader js-preloader">
        ...
        <div class="preloader__progress">
            <img src="img/logo/1.png" alt="preloader image" class="preloader__img animate__animated animate__zoomIn" width="300px">
        </div>
    </div>
                        ...
                        <div class="menu js-menu">
                                                        ...
                                                        <ul class="mega__menu">
                                                            <li class="mega__column">
                                                                <div class="mega__item">
                                                                    <center>
                                                                        <h4 class="mega__title">Water Heater</h4>
                                                                        <a href="water-heater"><img
                                                                                src="img/icon/water-heater1.svg"
                                                                                width="100"
                                                                                style="color:rgba(1, 129, 74);"></a>
                                                                    </center>
                                                                </div>
                                                            </li>
                                                            <li class="mega__column">
                                                                <div class="mega__item">
                                                                    <center>
                                                                        <h4 class="mega__title">Heat Pump</h4>
                                                                        <a href="heat-pump"><img
                                                                                src="img/icon/heat_pump.svg"
                                                                                width="100"></a>
                                                                    </center>
                                                                </div>
                                                            </li>
                                                            <li class="mega__column">
                                                                <div class="mega__item">
                                                                    <center>
                                                                        <h4 class="mega__title">Air Conditioner</h4>
                                                                        <a href="air-conditioner"><img
                                                                                src="img/icon/air-conditioner.svg"
                                                                                width="100"></a>
                                                                    </center>
                                                                </div>
                                                            </li>
                                                            <li class="mega__column">
                                                                <div class="mega__item">
                                                                    <center>
                                                                        <h4 class="mega__title">Water Dispenser</h4>
                                                                        <a href="water-dispenser"><img
                                                                                src="img/icon/water-dispenser.svg"
                                                                                width="100"></a>
                                                                    </center>
                                                                </div>
                                                            </li>
                                                            <li class="mega__column">
                                                                <div class="mega__item">
                                                                    <center>
                                                                        <h4 class="mega__title">LED Lighting</h4>
                                                                        <a href="led-lighting"><img
                                                                                src="img/icon/led-lamp.svg"
                                                                                width="100"></a>
                                                                    </center>
                                                                </div>
                                                            </li>
                                                            <li class="mega__column">
                                                                <div class="mega__item">
                                                                    <center>
                                                                        <h4 class="mega__title">Deep Freezer</h4>
                                                                        <img src="img/icon/comming.svg" width="100"
                                                                            style="margin-top: 05px;margin-left: 20px;color:rgba(216, 65, 41)">
                                                                    </center>
                                                                </div>
                                                            </li>
                                                        </ul>
                            ...
                            <div class="mobile__footer js-mobile-footer">
                                ...
                                <div class="mobile__copyright">
                                    ...
                                    <p>© 2024 Techmark. All rights reserved.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto sm:pos-unset js-header-item pe-0  p-0">
                        ...
                        <div class="instagram">
                            <a href="#" class="instagram__item">
                                <div class="instagram__image">
                                    <div class="ratio ratio-1:1 bg-image js-lazy"
                                        data-bg="img/main-sidebar/instagram/1.jpg"></div>
                                </div>
                            ...
                            <a href="#" class="instagram__item">
                                <div class="instagram__image">
                                    <div class="ratio ratio-1:1 bg-image js-lazy"
                                        data-bg="img/main-sidebar/instagram/2.jpg"></div>
                                </div>
                                <div class="instagram__content">
                                    <i class="icon fa fa-instagram" aria-hidden="true"></i>
                                </div>
                            ...
                            <a href="#" class="instagram__item">
                                <div class="instagram__image">
                                    <div class="ratio ratio-1:1 bg-image js-lazy"
                                        data-bg="img/main-sidebar/instagram/3.jpg"></div>
                                </div>
                                <div class="instagram__content">
                                    <i class="icon fa fa-instagram" aria-hidden="true"></i>
                                </div>
                            ...
                            <a href="#" class="instagram__item">
                                <div class="instagram__image">
                                    <div class="ratio ratio-1:1 bg-image js-lazy"
                                        data-bg="img/main-sidebar/instagram/4.jpg"></div>
                                </div>
                                <div class="instagram__content">
                                    <i class="icon fa fa-instagram" aria-hidden="true"></i>
                                </div>
                            ...
                            <a href="#" class="instagram__item">
                                <div class="instagram__image">
                                    <div class="ratio ratio-1:1 bg-image js-lazy"
                                        data-bg="img/main-sidebar/instagram/5.jpg"></div>
                                </div>
                                <div class="instagram__content">
                                    <i class="icon fa fa-instagram" aria-hidden="true"></i>
                                </div>
                            ...
                            <a href="#" class="instagram__item">
                                <div class="instagram__image">
                                    <div class="ratio ratio-1:1 bg-image js-lazy"
                                        data-bg="img/main-sidebar/instagram/6.jpg"></div>
                                </div>
                                <div class="instagram__content">
                                    <i class="icon fa fa-instagram" aria-hidden="true"></i>
                                </div>
